          ...
          <div className="mt-4 mb-1 bg-card rounded-lg p-4 pb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex items-center justify-between py-2 border-b border-gray-700">
                ...
                <span className="font-mono font-medium text-green-400">${formatNumber(safeObj(playerStats, 'money.current', 0) || safeObj(playerStats, 'money_onhand', 0))}</span>
              </div>
              
              <div className="flex items-center justify-between py-2 border-b border-gray-700">
                <span className="text-sm">Points</span>
                <span className="font-mono font-medium text-yellow-400">{formatNumber(safeObj(playerStats, 'money.points', 0) || safeObj(playerStats, 'points', 0))}</span>
              </div>
              
              <div className="flex items-center justify-between py-2 border-b border-gray-700">
                <span className="text-sm">Bank</span>
                <span className="font-mono font-medium text-green-400">${formatNumber(safeObj(playerStats, 'money.bank', 0) || safeObj(playerStats, 'city_bank.amount', 0))}</span>
              </div>
